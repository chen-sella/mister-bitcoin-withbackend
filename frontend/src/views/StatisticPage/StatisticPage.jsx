...
export class StatisticPage extends Component {
  ...
  async transactionData() {
    ...
    const transactionLabels = data.map((coord) => new Date(coord.x).toLocaleTimeString());
      ...
      datasets: [
        {
          ...
          borderColor: 'rgba(75, 154, 234, 0.2)',
        },
      ],
    };
  ...
  async marketData() {
    ...
    const marketPriceLabels = data.map((coord) => new Date(coord.x).toLocaleTimeString());
    const marketData = {
